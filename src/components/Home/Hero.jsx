  ...
  return (
    <div className="text-white w-full bg-gradient-to-r from-[#000300] to-[#0c4b37]">
      <section className="md:max-w-[1240px] overflow-hidden mt-[-96px] h-screen mx-auto text-left flex flex-col justify-center px-4 ">
        ...
        <Link
          to="/about"
          className="bg-[#00df9a] md:w-[200px] w-[150px] rounded-md font-medium  my-6  py-3 px-4 text-black text-[17px]  md:text-xl  flex text-center justify-center items-center transition-all duration-100 hover:bg-transparent  hover:outline outline-[#00df9a] hover:text-[#00df9a]"
        >
          About Me
        </Link>
      </section>
